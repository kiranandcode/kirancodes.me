...
#+NAV_SECTIONS: [[file:index.org][About Me]] [[*Publications][Publications]] [[file:cafe-guide.org][Cafe Guide!]] [[file:posts.org][Posts]]
...
Hi, I'm Kiran (she/her)! I am currently a Research Scientist working
on AI+PL at the [[https://basis.ai][Basis Research Institute]]. Previously I was a
Postdoctoral Researcher at the University of Illinois Urbana
Champaign, advised by [[https://dependenttyp.es][Talia Ringer]]. Before then, I completed my PhD
from the National University of Singapore advised by [[https://ilyasergey.net/][Ilya Sergey]] in
[[https://verse-lab.github.io][VERSE Lab]].

My academic research focused on the problem of proof maintenance:
developing newer and better tools for the maintenance and automation
of formal verification---the process of using computers to construct
